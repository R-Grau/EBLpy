...
if Spectrum_func_name == "PWL":
    ...
    def dNdE_absorbed(K, E, Norm, Ph_index, b):
...
if Telescope == "CTAN_alpha":
    ...
    if Spectrum_func_name == "PWL":
        ...
        dNdEa = dNdE_absorbed(Source_flux, E_EBL, Norm, Ph_index, LP_curvature)
...
#     if not os.path.exists('/data/magic/users-ifae/rgrau/EBL-splines/EBL{niter}_{func1}({curv})_{func2}_starta1'.format(curv = LP_curvature, func1 = Spectrum_func_name, func2 = fit_func_name, niter = niter)):
#         os.mkdir('/data/magic/users-ifae/rgrau/EBL-splines/EBL{niter}_{func1}({curv})_{func2}_starta1'.format(curv = LP_curvature, func1 = Spectrum_func_name, func2 = fit_func_name, niter = niter))
#     hdf5filename = "/data/magic/users-ifae/rgrau/EBL-splines/EBL{niter}_{func1}({curv})_{func2}_starta1/EBL_mult_nit{nit}of{niter}_{datetime}.hdf5".format(curv = LP_curvature, func1 = Spectrum_func_name, func2 = fit_func_name ,nit = iter, niter = niter, datetime = datetime)
# else:
if not os.path.exists('/data/magic/users-ifae/rgrau/EBL-splines/EBL{niter}_{func1}_{func2}_{knots}knots'.format(func1 = Spectrum_func_name, func2 = fit_func_name, niter = niter, knots = knots)):
    os.mkdir('/data/magic/users-ifae/rgrau/EBL-splines/EBL{niter}_{func1}_{func2}_{knots}knots'.format(func1 = Spectrum_func_name, func2 = fit_func_name, niter = niter, knots = knots))
hdf5filename = "/data/magic/users-ifae/rgrau/EBL-splines/EBL{niter}_{func1}_{func2}_{knots}knots/EBL_mult_nit{nit}of{niter}_{datetime}.hdf5".format(func1 = Spectrum_func_name, func2 = fit_func_name ,nit = iter, niter = niter, datetime = datetime, knots = knots)

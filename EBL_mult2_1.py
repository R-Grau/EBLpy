    ...
    if Telescope == "CTAN_alpha": #this part needs to be changed to include the real CTAN_alpha configuration
        ...
        def m2LogL(params):
            ...
            conditions = [((Non_final >= min_num_gauss) & (Noff_final >= min_num_gauss)),
                          ...
                          (Non_final != 0.) & (Noff_final != 0.)]
            if IRF_u:
                choices = [Gauss_logL_IRF(Non_final, Noff_final, mu_gam_final, mu_gam_final_u, Nwobbles),
                           Poisson_logL_Non0_IRF(Non_final, Noff_final, mu_gam_final, mu_gam_final_u, Nwobbles),
                           Poisson_logL_Noff0_IRF(Non_final, Noff_final, mu_gam_final, mu_gam_final_u, Nwobbles),
                           Poisson_logL_IRF(Non_final, Noff_final, mu_gam_final, mu_gam_final_u, mu_bg_final, Nwobbles)]
            else:
                choices = [Gauss_logL(Non_final, Noff_final, mu_gam_final, Nwobbles),
                           Poisson_logL_Non0(Non_final, Noff_final, mu_gam_final, Nwobbles),
                           Poisson_logL_Noff0(Non_final, Noff_final, mu_gam_final, Nwobbles),
                           Poisson_logL(Non_final, Noff_final, mu_gam_final, mu_bg_final, Nwobbles)]
